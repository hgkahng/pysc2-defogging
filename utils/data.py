...
class DefoggingDataset(Dataset):
    def __init__(self, root_dir: str = "./data/defogging/", size: int = 32, matchup: str = "TvP", use_count: bool = False):
        ...
        pattern = os.path.join(self.root_dir, matchup, f"**/{size}x{size}/*.npz")
